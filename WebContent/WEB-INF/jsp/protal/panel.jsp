...
<head>
	...
	<link href="<%=path %>/js/jquery-easyui-1.5/themes/default/easyui.css" rel="stylesheet">
	<link href="<%=path %>/js/jquery-easyui-1.5/themes/icon.css" rel="stylesheet">
...
<body class="nav-md">
    ...
    <div class="container body" style="margin: 0px 0px; padding: 0px 0px; width: 100%">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>数据可视化系统!</span></a>
            </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="<%=path %>/login.jsp">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<%=path %>/images/img.jpg" alt=""><%=username %>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="<%=path %>/images/img.jpg" alt="Profile Image" /></span>
                        <span>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  	<div><form id="searchDataForm">
						筛选: 金额<input id="start_price" name="start_price"  type="text"  class="easyui-textbox" style="width: 120px"> 到 
						<input id="end_price" name="end_price" class="easyui-textbox" style="width: 120px"><!-- 栏目: 
						...
						在库数量<input id="start_num" name="start_num"  type="text"  class="easyui-textbox" style="width: 120px"> 到 
						<input id="end_num" name="end_num" class="easyui-textbox" style="width: 120px">
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" onclick="searchData()" style="margin-right: 10px">筛选</a>
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-clear" onclick="searchClean()">清空</a>
						</form>
					</div>
                  	<div id="main_scatter" style="width: 600px;height:600px; margin-top:20px; float: left;"></div>
					<div id='select_itm_total_pie' style="width: 350px;height:270px;  margin-top:20px; float: left;"></div>
					<div id='select_itm_mass_pie' style="width: 350px;height:270px;  margin-top:20px; float: left;"></div>
  ...
  <script>
    ...
    /* 	var x,y;
        ...
        */
        ...
        var data;
        var myChart = echarts.init(document.getElementById('main_scatter'));
        var myTotalPieChart = echarts.init(document.getElementById('select_itm_total_pie'));
        var myMassPieChart = echarts.init(document.getElementById('select_itm_mass_pie'));
        ...
        */
        ...
        function renderBrushed(params) {
            ...
            for (var i = 0; i < Math.min(selectedItems.length, maxBar); i++) {
                ...
                kc_num.push(selectedItems[i][4]);
                itm_total.push(selectedItems[i][1]);
                itm_mass.push(selectedItems[i][3]);
          		temp_itm_cd.push('物料:' + selectedItems[i][2]);
            }
            
            if(temp_itm_cd != null) {
	            //	动态添加框选的散点并创建金额饼状图
	            addSelectItmTotalPie(temp_itm_cd);
				//  动态添加框选的散点并创建体积饼状图
	            addSelectItmMassPie(temp_itm_cd);
	            // 动态添加框选的散点并创建拆线图
	            moreChart();
            }
        };
        ...
        */
        ...
        //	动态添加框选的散点并创建金额饼状图
        function addSelectItmTotalPie(temp_itm_cd) {
       		var len = temp_itm_cd.length;
       		var series_data = [];
       		for(var i=0; i<len; i++) {
       			series_data.push({name : temp_itm_cd[i], value : itm_total[i]})
       		}
       		var option_pie = {
       				//legend:{data : itm_cd},//图例
       				title : {
               	        text: '物料库存金额',
               	    },
                    series: {
                	...
                	tooltip : {//提示框
               	        ...
               	        //showDelay : 0,//鼠标经过提示
               	        formatter : function (params) {
    	        	            return params.name + '<br/>金额:' + params.value + '元';
               	        },
               	    },
       		}
       		
       		myTotalPieChart.setOption(option_pie);
        }
        
    	//  动态添加框选的散点并创建体积饼状图
        function addSelectItmMassPie(temp_itm_cd) {
       		var len = temp_itm_cd.length;
       		var series_data = [];
       		for(var i=0; i<len; i++) {
       			series_data.push({name : temp_itm_cd[i], value : itm_mass[i]})
       		}
       		var option_pie = {
       				//legend:{data : itm_cd},//图例
       				title : {
       		...
       		myMassPieChart.setOption(option_pie);
    	}	
        ...
        function searchData() {
        	var start_price = $('#start_price').textbox('getValue');
        	var end_price = $('#end_price').textbox('getText');
        	var start_num = $('#start_num').textbox('getText');
        	var end_num = $('#end_num').textbox('getText');
        	
    		//classID = $('#classID').combotree('getValue');
    		$.ajax({
				url : 'getSearchData.action',
				type : 'post',
				data : {'start_price':start_price,'end_price':end_price,'start_num':start_num,'end_num':end_num},
				success : function(data) {
					if(data.status == 200) {
						all_data = data.data;
						console.log(all_data);
